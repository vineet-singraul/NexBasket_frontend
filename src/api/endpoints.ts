...
export const AI_MODEL = {
  ...
  GENRATE_SPECIFICATION_OF_PRODUCTS: (productName: string) =>
    `/AiGenration/generateSpecificationOfProduct/${encodeURIComponent(productName)}`,
  GENRATE_SEO_SEARCH_KEYWORD_META: (productName: string) =>
...
export const OWNER_DASHBOARD_API = {
  GET_ALL_DETAILS_OWNER_DASHBOARD: (storeId: string, ownerId: string) =>
    `/ownerDashboard/${storeId}/${ownerId}`,
}
